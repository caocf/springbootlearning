<%@page import="com.cus.common.settings.PageSettings"%>
...
<c:if  test="${page.pageResult.totalElements le 0}">
	<div class="noresult">数据库中查不到数据信息</div>
</c:if>